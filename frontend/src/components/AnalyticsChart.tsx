...
export default function AnalyticsChart({data}: Props) {
    const stats = [
        { name: 'Labelled today', stat: data.analytics[0].total_amount, previousStat: '70,946', change: '12%', changeType: 'increase' },
    ...
    function getDayOfWeek(dateString:string) {
        ...
        // Get the name of the weekday using the day of the week obtained
        ...
        <div style={{height:"500px",width:"1000px"}}>
            ...
            <ResponsiveContainer width="100%" height="100%">
                ...
                >
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="total_amount" fill="#8884d8" activeBar={<Rectangle fill="pink" stroke="blue" />} />
                </BarChart>
            </ResponsiveContainer>
        </div>
        </div>

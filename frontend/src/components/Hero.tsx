                    ...
                    <div className="max-w-xl">
                        ...
                        <div className="mt-6">
                            ...
                            <p className="text-white mt-6 text-balance">
                                Transform your data into visually stunning
                                infographics that captivate your audience. With
                                a wide range of customizable templates and
                                creative elements, you can present your data in
                                a visually appealing and impactful way.
                            </p>

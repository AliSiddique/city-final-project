  ...
  <div className="lg:max-w-xl mx-auto px-8">
    <div className="w-full mx-auto">
      <div
        ...
        <div
          className="flex flex-row items-center justify-between md:justify-start">
          <a
        ...
        <nav
          className="flex-col flex-grow hidden py-12 md:py-0 md:flex md:items-end justify-center md:flex-row">
          <ul
            className="space-y-2 list-none md:space-y-0 text-xs text-white md:ml-auto items-center md:inline-flex justify-center text-center md:text-left gap-3">
            <li>
              <a
                href="/"
                title="link to your page"
                aria-label="your label"
                className="lg:py-10 hover:text-blue-400">
                Overview
              </a>
            </li>
            <li>
